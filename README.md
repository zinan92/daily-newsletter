...
# 2. 配置 LLM 端点（本地 CLIProxyAPI，默认 localhost:8317）
export PARKIO_CLIPROXY_ENDPOINT="http://localhost:8317/v1/messages"
export PARKIO_CLIPROXY_KEY="your-proxy-key"
export PARKIO_CLIPROXY_MODEL="claude-sonnet-4-5-20250929"
