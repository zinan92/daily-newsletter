...
LEGACY_SENT_DIR = PARKIO / "001_daily newsletter" / "ai"
SENT_DIR = PARKIO / "006_ai daily newsletter"
...
PROFILE_ID_BY_SOURCE_NAME = {
    ...
    "Kevin Weil": "openai",
    "Mark Chen": "openai",
    "SpaceXAI X": "xai", "Grok X": "xai", "Grok YouTube": "xai",
    "Gemini Blog": "google", "Google DeepMind Blog": "google", "Google Developers Blog": "google", "Google AI Blog": "google",
    "Google DeepMind X": "google", "Gemini App X": "google", "Google AI Devs X": "google",
    "Demis Hassabis": "google", "Logan Kilpatrick": "google",
    "Google DeepMind YouTube": "google", "Google for Developers YouTube": "google",
    "AI at Meta X": "meta", "Alexandr Wang": "meta",
    "Z.ai X": "zhipu",
    "Kimi X": "moonshot", "kimi-cli-releases": "moonshot", "Kimi YouTube": "moonshot",
    "DeepSeek X": "deepseek",
    "MiniMax X": "minimax", "Hailuo X": "minimax", "minimax-code-releases": "minimax",
    "ByteDance OSS X": "bytedance",
    "Qwen X": "qwen", "Junyang Lin": "qwen", "Binyuan Hui": "qwen", "qwen-code-releases": "qwen", "Qwen YouTube": "qwen",
    "慢学AI": "manxue-ai",
