...
| 17 | Personal collection index: single `002_个人收藏/_manual-links.md` table with date/source/author/title/category/tags/status/file/source URL; `Pending` remains only as a temporary compatibility inbox | ⚪ | convention · `ingestion/collection_index.py` · `ingestion/collection_taxonomy.py` · `ingestion/manual_links/run.py` |
